  ...
  return (
    <div className="learning-page">
      <div className="learning-hero">
        <div>
          <div className="learning-kicker">LEARNING HUB</div>
          <div className="learning-title">Training Command Console</div>
      ...
      <div className="learning-grid">
        {cards.map((card) => (
          <div
            key={card.title}
            className={`learning-card ${card.disabled ? "is-disabled" : ""}`}
            onClick={() => !card.disabled && nav(card.route)}
          >
            <div className="learning-card-title">{card.title}</div>
            <div className="learning-card-body">{card.description}</div>
            <div className="learning-card-cta">
